const  { sayHello, addNumbers, isPositive, multiply, minutesToSeconds, sumOrEqualto100, returnHello, calculateFuel, shouldServeDrinks, getLastItem } = require('../veryEasyChallenges/veryEasyChallenges.js')
